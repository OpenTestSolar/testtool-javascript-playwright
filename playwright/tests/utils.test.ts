...
describe('parseErrorCases', () => {
    ...
    test('none suites and none errors cases', () => {
        ...
        const result = parseErrorCases(jsonData, cases);
        expect(result).toHaveProperty('testCase1');
        expect(result.testCase1[0].message).toBe('日志为空，请检查用例本地是否跑通，或者联系腾讯云助手');
    });
});
...
describe('parseJsonContent', () => {
    test('should parse JSON content and return case results', () => {
        ...
        expect(result).toEqual({"tests/spec1.js?Suite 1 Spec 1": [{"content": "Error 2\
        ", "duration": 1, "endTime": 1672531201, "message": "", "projectID": "proj1", "result": "passed", "startTime": 1672531200},{
            "content": "Error 2\
            ","duration": 1,"endTime": 1672531201,"message": "","projectID": "proj1","result": "passed","startTime": 1672531200,}], "tests/spec2.js?Suite 2 Spec 2": []});
    });
});
